...
$sqlAdmin = "SELECT * FROM alumno WHERE id_usuario = '$id_usuario'";
...
<body>
    ...
    <main>
        <div class="login-form">
            ...
            <form action="../Controlador/ProfileStudent.php?id_usuario=<?php echo $id_usuario; ?>" method="POST" onsubmit="return validateFormUpdate()">
